...
CHECKPOINT_FILE="${CHECKPOINT_FILE:-ft-model-00001-of-00001.bin}"
QUANTIZED_CHECKPOINT_FILE="${QUANTIZED_CHECKPOINT_FILE:-ft-model-00001-of-00001-8da4w.pt}"
...
# For Llama3-8B, eval hellaswag and wikitext separately to avoid OOM
