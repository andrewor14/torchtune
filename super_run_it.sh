...
MODEL="Qwen3-1.7B" EPOCHS="3" ENABLE_QAT="false" ./run_it.sh
MODEL="Qwen3-1.7B" EPOCHS="3" ENABLE_QAT="true" ENABLE_LORA="false" ./run_it.sh
MODEL="Qwen3-1.7B" EPOCHS="3" ENABLE_QAT="true" ENABLE_LORA="true" ./run_it.sh
