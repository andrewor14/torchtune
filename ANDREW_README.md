...
Go ahead and run the experiments! By default, this fine-tunes Qwen3-1.7B with and without QAT on alpaca for 1 epoch. This is full fine-tuning, i.e. no LoRA.
